...
namespace SupperClub.Domain
{
    ...
    {
        public static decimal vatPercent = decimal.Parse(WebConfigurationManager.AppSettings["VATPercent"]);
        // public static decimal commissionPercent = decimal.Parse(WebConfigurationManager.AppSettings["CommissionPercent"]);
        public static decimal commissionFixed = decimal.Parse(WebConfigurationManager.AppSettings["CommissionFixed"]);
