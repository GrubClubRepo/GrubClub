...
SET @ScriptCode='2015.11.24.Update_EmailTemplate19'
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="366" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">
                            ...
                            Unfortunately your event was unable to be listed.
                        </td>
                    </tr>
                </tbody></table>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                        ...
                                        <img align="left" alt="Time is nearly up!" src="[serverURL]Content/images/email/reject-GrubClub.jpg" width="564" style="max-width:607px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <div><span style="font-size:16px"><strong>Thanks for taking the time to upload&nbsp;your Grub Club. Unfortunately, we''re unable to approve your <a href="[eventURL]" target="_blank">Grub Club</a> on this occasion.</strong></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <span style="font-size:16px"><span style="color:#FF5E00"><strong>Here are some reasons why we might decline an event:</strong></span></span>
<ul>
	<li>The event is too short notice / has already passed.</li>
	<li>The event isn''t in the Grub Club style (i.e. social dining - guests can come alone)</li>
	<li>We don''t think that the event would appeal to the Grub Club audience.</li>
	<li>The event is outside of the area we operate in.</li>
</ul>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            You can see what we think makes a successful Grub Club <a href="http://example-grub-club.instapage.com/" target="_blank">HERE</a>.<br>
<br>
Feel free upload any future events that you believe would work well on the site.<br>
<br>
If you''d like any further feedback, please email <strong><a href="mailto:eat@grubclub.com" target="_blank">eat@grubclub.com</a></strong>.
                        </td>
                    </tr>
                </tbody></table>
