...
SET @ScriptCode='2013.06.20.Update_EmailTemplate2'
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div style="color: #808080;font-family: Arial;font-size: 12px;line-height: 150%;text-align: left;">
																...
																Your password has been reset and is now [newPassword].</h2>
																<br>
																<p>
																	To change it please login and go to <a href="[serverURL]Account/ChangePassword" style="color: #ff7500;text-decoration: none;">[serverURL]Account/ChangePassword</a>
																</p>
																<br />
																<p>
																	Thanks,
