...
SET @ScriptCode='2015.11.24.Update_EmailTemplate17'
                                                ...
                                                <tbody class="mcnTextBlockOuter">
                                                    <tr>
                                                        <td valign="top" class="mcnTextBlockInner">
                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="200" class="mcnTextContentContainer">
                                                                <tbody>
                                                                    <tr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">
                                                                            ...
                                                                            Your event has been submitted to Grub Club HQ.
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                                                            ...
                                                                            <img align="left" alt="Time is nearly up!" src="[serverURL]Content/images/email/create-GrubClub.jpg" width="564" style="max-width:981px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" />
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                            ...
                                                                            <div><span style="font-size:18px"><strong>Thanks for taking the time to upload&nbsp;your Grub Club.</strong></span></div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                            ...
                                                                            <span style="color:#FF5E00"><span style="font-size:18px"><strong>... So, what happens next:</strong></span></span><br />
                                                                            <br />
                                                                            We will review your submission at <strong>Grub Club HQ</strong> + get back to you within&nbsp;<strong>two working days</strong>.<br />
                                                                            <br />
                                                                            You can preview your event page here: <a href="[grubClubURL]" target="_blank">[grubClubName]</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                            ...
                                                                            <span style="line-height:20.7999992370605px">See what makes a great event&nbsp;</span><a href="http://example-grub-club.instapage.com/" style="line-height: 20.7999992370605px;" target="_blank">HERE</a><span style="line-height:20.7999992370605px">. Does your page need some sprucing up?&nbsp;You can&nbsp;</span><strong style="line-height:20.7999992370605px">add/edit details</strong><span style="line-height:20.7999992370605px">&nbsp;of your page by clicking "</span><strong style="line-height:20.7999992370605px">Edit Event</strong><span style="line-height:20.7999992370605px">
                                                                                ".<br />
                                                                                <br />
                                                                                Please be aware that your event booking page is inactive until approval.
                                                                            </span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
