...
-- Summary:	Updated condition to mark a chef as "Brand New"

DECLARE @ScriptCode nvarchar(50)
SET @ScriptCode='2016.01.29.UpdateSearch'
...
----SCRIPT GOES BELOW THIS LINE--------------------------------------------------------
	...
	ALTER PROCEDURE [dbo].[Search] --''4/12/2014'',3,10,2,10,100,'''','''',null,null,'''',null,null                          
...
CREATE TABLE #OtherDateOptions(Name nvarchar(500) COLLATE Latin1_General_CI_AS, SeatsAvailable BIT, EventCount INT)                                                 
 ...
 ,case when ((select datediff(DAY, MIN(DateCreated),getdate()) from event where supperclubid=S.Id)<=60) then ''1'' else ''0'' end as BrandNew                        
