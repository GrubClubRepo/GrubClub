...
SET @ScriptCode='2013.06.20.Update_EmailTemplate3'
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div style="color: #808080;font-family: Arial;font-size: 12px;line-height: 150%;text-align: left;">
																...
																FYI: A new Grub Club called "[grubClubName]" has just been registered!</h2>
																<br>													
																<p>
																	This Grub Club is run by "[userName]" with email address: [userEmail]
																</p>
																<p>
																	You need to remember to activate this Grub Club before their events will be searchable!
																</p>
															</div>
														</td>
                                                    </tr>
