...
SET @ScriptCode='2013.01.01.Insert_EmailTemplate9'
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div style="color: #808080;font-family: Arial;font-size: 12px;line-height: 150%;text-align: left;">
																...
																You''ve recieved a new review!</h2>
																<br>
																<p>
																	We hope you enjoyed hosting [eventName] on [eventDate].
																</p>
																<p>
																	You''ve recieved a review! <a href="[serverURL]Event/Details?eventId=[eventId]">Click here</a> to see it.
																</p>
																<p>
																	If you have any questions, feel free to <a href="http://grubclub.com/Home/ContactUs">contact us</a>. If you haven''t already done so, don''t forget to <a href="http://grubclub.com/Event/CreateEvent">host your next event</a>.
																</p>
																<p>
																	We look forward to helping you organise another one!
																</p>
																<br />
																<p>
																	Thanks,
