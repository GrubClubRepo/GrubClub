...
SET @ScriptCode='2015.11.24.Update_EmailTemplate5'
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="40%" class="mcnTextContentContainer">
                    <tbody><tr>
                        
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:0;">
                        
                            Your seats are flying!
                        </td>
                    </tr>
                </tbody></table>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                        ...
                                        <img align="left" alt="Time is nearly up!" src="[serverURL]Content/images/email/booking-alert.jpg" width="564" style="max-width:719px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <div><span style="font-size:16px"><strong>You''ve received a booking...</strong></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                              ...
                              <p>                  Event Name: [eventName]<br />                                                      Event Date and Time: [eventDate]<br /><br />                                                                                                                                                       Guest: [userName] has booked [numberTickets] places with booking reference #[bookingReference].  </p>   
                              <p>                  Special Requirements: [bookingRequirements]                 </p> 
                        </td>
                    </tr>
                </tbody></table>
                    ...
                    <table align="left" width="273" border="0" cellpadding="0" cellspacing="0" class="mcnImageGroupContentContainer">
                            <tbody><tr>
                                <td class="mcnImageGroupContent" valign="top" style="padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                    ...
                                    <a href="http://www.host-marketing-tips.instapage.com/" title="" class="" target="_blank">
                                        <img alt="Host Tips" src="[serverURL]Content/images/email/Host-tips.jpg" width="264" style="max-width:410px; padding-bottom: 0;" class="mcnImage">
                                    </a>
                    ...
                    <table align="right" width="273" border="0" cellpadding="0" cellspacing="0" class="mcnImageGroupContentContainer">
                            <tbody><tr>
                                <td class="mcnImageGroupContent" valign="top" style="padding-right: 9px; padding-top: 0; padding-bottom: 0;">
                                    ...
                                    <a href="http://admin-tips.instapage.com/" title="" class="" target="_blank">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            Please look carefully at any dietary requirements and let the guest (and us!) know if you''re unable to fulfil them.
                        </td>
                    </tr>
                </tbody></table>
