...
-- Summary:	This updates the email template for event approval confirmation email to chefs

DECLARE @ScriptCode nvarchar(250)
SET @ScriptCode='2017.02.25.UpdateEventApprovalEmailTemplate'
...
UPDATE dbo.[EmailTemplate] WITH(ROWLOCK)
SET Body = '
                                                                ...
                                                                <tbody>
                                                                  ...
                                                                  <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                            ...
                                                                            And as a reminder,  <a href="http://host-journey.grubclub.com/" target="_blank">here is an overview of your journey as Grub Club host.</a> We''re excited that you have joined the Dining Revolution! 
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
...
WHERE Id=18 AND Subject = 'Grub Club Approval Confirmation'
