...
-- Summary:	Added condition in where clause to filetr private events in search results

DECLARE @ScriptCode nvarchar(50)
SET @ScriptCode='2013.04.10.UpdateSearch'
...
----SCRIPT GOES BELOW THIS LINE--------------------------------------------------------
	...
	ALTER PROCEDURE [dbo].[Search] -- EXEC Search ''2013-04-10'',10, 51.5073346, -0.1276831,2,0,200,'''',''''
	@StartDate datetime,
	@Distance int,
	@Latitude float,
	@Longitude float,
