...
-- Summary:	This inserts the Email Template for sending the notification

DECLARE @ScriptCode nvarchar(50)
SET @ScriptCode='2014.01.24.Insert_EmailTemplate16'
