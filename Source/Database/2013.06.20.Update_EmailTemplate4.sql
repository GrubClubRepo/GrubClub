...
SET @ScriptCode='2013.06.20.Update_EmailTemplate4'
...
INSERT INTO [SupperClub].[dbo].[EmailTemplate]
     ...
     VALUES
           (4, 'GrubClub Event Booking Confirmation', 'True',
           N'
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            ...
                                            <span align="center" style="font-size: 1.0em;font-family: Arial;"> DO NOT REPLY TO THIS EMAIL</span><br/><br/>
                                            	<!-- // Header Image \ -->
                                            	<img src="[serverURL]Content/images/email/3.Your_event_FINAL.jpg" style="max-width:600px;" id="headerImage campaign-icon">
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div style="color: #808080;font-family: Arial;font-size: 12px;line-height: 150%;text-align: left;">
																...
																Get ready for a Social and Culinary Experience.</h2>
																<br>													
																<p>
																	Here are the details of your event:
																</p>
																<p>
																	Grub Club: [grubClubName]<br />
																	Event Name: [eventName]<br />
																	Event Date and Time: [eventDate]<br />
																	Please be prompt, arriving early or late can affect everyone’s dining experience.
																</p>
																<p>
																	Special Requirements: [bookingRequirements]
																</p>
																<p>
																	Rough Location: <a href="http://maps.google.co.uk/?q=[eventPostCode]" style="color: #ff7500;text-decoration: none;">[eventPostCode]</a><br />
																	You will be emailed full address details prior to the event.
																</p>
																<p>
																	Alcohol Policy: [alcoholPolicy]
																</p>
																<p>
																	Your Receipt:<br/>
