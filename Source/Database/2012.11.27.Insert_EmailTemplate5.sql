...
SET @ScriptCode='2012.11.27.Insert_EmailTemplate5'
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<!-- // Header Image \ -->
                                            	<img src="[serverURL]Content/images/email/6.You-have-a-booking_FINAL.jpg" style="max-width:600px;" id="headerImage campaign-icon">
                                                        ...
                                                        <td valign="top">
                                                            <div style="color: #808080;font-family: Arial;font-size: 12px;line-height: 150%;text-align: left;">
																...
																<p>
																	...
																	Guest: [userName] has booked [numberTickets] places with booking reference #[bookingReference].
																</p>
																<p>
																	Special Requirements: [bookingRequirements]
																</p>
																<p>
																	If you are happy with the booking, no further action is required.<br />
																	If you have any questions please contact us <a href="[serverURL]Home/ContactUs" style="color: #ff7500;text-decoration: none;">here</a>.
																</p>
																<p>
																	If you <strong>do not</strong> want to accept this booking please login <a href="[serverURL]Event/Details?eventId=[eventId]" style="color: #ff7500;text-decoration: none;">here</a>, go to the Guests tab and click the reject button for this Guest.
																</p>
																<br />
																<p>
																	Thanks,
