...
namespace ChefNewEventNotificationService.Helpers
{
    ...
    public class EmailHelper
    {
        ...
        public bool UpdateEmailNotificationSentStatus(Guid userId, string eventIds)
        {
            emailSentStatus = false;
            try{
            SqlConnection con = new SqlConnection();
            con.ConnectionString = Configuration.ConnectionString;
            SqlCommand command = new SqlCommand("UpdateEmailSentStatus", con);
            command.CommandType = CommandType.StoredProcedure;
        ...
        public bool UpdateEmailNotificationSentStatusForFollowChef(Guid userId, string eventIds)
        {
            emailSentStatus = false;
            try{
            SqlConnection con = new SqlConnection();
            con.ConnectionString = Configuration.ConnectionString;
            SqlCommand command = new SqlCommand("UpdateEmailSentStatusForFavouriteSupparClubEvent", con);
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.Add(new SqlParameter("@UserId", userId));
            command.Parameters.Add(new SqlParameter("@EventIds", eventIds));
            DataSet ds = new DataSet();
