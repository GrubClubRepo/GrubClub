...
$(this).magnificPopup({
    ...
    }), $(".word-count").on("focus change keydown keypress keyup blur", function () { var e = $(this), n = e.next().find(".words-left"), t = e.val(), o = /\s+/gi, i = t.trim().replace(o, " ").split(" ").length, s = 300; if (0 == t.length) return void n.html(0); if (i > s) { var a = e.val().split(/\s+/gi, s).join(" "); $(this).val(a + " ") } else n.html(i) }), $(".character-count").on("focus change keydown keypress keyup blur", function () { var e = $(this), n = e.next().find(".character-left"), t = e.val(), o = t.length; return 0 == t.length ? void n.html(0) : void n.html(o) }),
